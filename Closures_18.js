    ...
    return function(str) {
        if (str === 'undo') {
            ...
            if (history.length >= limit) {
                history.shift(); // Remove the oldest item if we've reached the limit
            }
            history.push(str);
            return `${str} done`;
        }
